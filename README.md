...
Ответ на запрос от бота должен иметь формат **json-строки** требуемых параметров (пустой, если отвечать на отправленную команду не требуется).
...
>}
>```
- version - версия API ботов. Ответ на команду бота добавилась в 3й версии Compass Userbot API;
