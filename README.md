...
- [Webhook и реагирование на команды](#Webhook-и-реагирование-на-команды)
    ...
    - [История изменений версии webhook бота](#История-изменений-версии-webhook-бота)
...
Если отвечать на отправленную команду не требуется, то передавать данные в ответе запроса необязательно.
...
#### История изменений версии webhook бота
...
В этой версии отправляемый на ваш webhook запрос будет содержать header-заголовок с токеном того бота, которому принадлежит отправленная команда:<br>
>заголовок "**Authorization: bearer={токен бота}**".<br>
