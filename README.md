...
| ![](screenshots/2523a2ad3d4e6e20.png) |
| --- |
...
Также запрос содержит header-заголовок, содержащий сгенерированную подпись для отправляемых данных (созданная по стандартной [схеме получения подписи](#Схема-получения-подписи-для-запроса)):<br>
